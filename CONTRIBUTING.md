...
- **Review the documentation and [Support Guide](https://github.com/space-nomad/.github/blob/main/SUPPORT.md)** before opening a new issue.
...
- **Update the CHANGELOG** for all enhancements and bug fixes. Include the corresponding issue number if one exists, and your GitHub username. (example: "- Fixed crash in profile view. #123 @sakhileln")
